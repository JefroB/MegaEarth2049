...
// Create event files
const level34QuestGiverPath = createEventFile(level34QuestGiver, 'level34_quest_giver.json');
const dataCrystal1Path = createEventFile(dataCrystal1, 'data_crystal1.json');
const dataCrystal2Path = createEventFile(dataCrystal2, 'data_crystal2.json');
const dataCrystal3Path = createEventFile(dataCrystal3, 'data_crystal3.json');
const level35QuestNPCPath = createEventFile(level35QuestNPC, 'level35_quest_npc.json');
...
console.log('');
console.log('For level 34 quest (Map047.json - Snowy Village):');
console.log(`- Add ${level34QuestGiverPath}`);
console.log(`- Add ${dataCrystal1Path}`);
console.log(`- Add ${dataCrystal2Path}`);
console.log(`- Add ${dataCrystal3Path}`);
console.log('');
console.log('For level 35 quest (Map103.json - Asteroid Belt):');
console.log(`- Add ${level35QuestNPCPath}`);
